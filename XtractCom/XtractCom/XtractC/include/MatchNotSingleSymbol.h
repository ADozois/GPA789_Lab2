...
{
public:
	//! Construit un `MatchNotSingleSymbol` initialisant le symbole 
	//!	de référence. Le symbole ne peut être modifié par la suite. 
	//! \param[in] symbols Le symbole de référence.
